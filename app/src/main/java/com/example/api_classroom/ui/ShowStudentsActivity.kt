...
class ShowStudentsActivity : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val call = request.getStudents(username,auth)
        call.enqueue(object : Callback<List<Student>> {
            ...
            override fun onResponse(
                ...
                if(response.isSuccessful){
                    ...
                    recycler_view.layoutManager = LinearLayoutManager(this@ShowStudentsActivity)
        ...
        buttonMain.setOnClickListener {
            startActivity(Intent(this@ShowStudentsActivity, ProfileActivity::class.java))
        }
