...
class ExampleAdapter(private val exampleList: Array<String?>,private val exampleList2: Array<String?>,private val exampleList3: Array<String?>,private val exampleList4: Array<String?>): RecyclerView.Adapter<ExampleAdapter.ExampleViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExampleViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.example_course, parent, false)
